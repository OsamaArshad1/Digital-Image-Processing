...
def myface():
    ...
    names = ['', 'user']  # names, leave first empty bcz counter starts from 0
    ...
    while True:
        ...
        for(x, y, w, h) in faces:
            ...
            checkAccuracy = round(100-accuracy)
            ...
            cv2.putText(img, str(accuracy), (x+5, y+h-5),
                        font, 1, (255, 255, 0), 1)
            if(checkAccuracy > 60):
                print(checkAccuracy, "You are verified")
                flag = False

                mylabel = Label(text=f"{checkAccuracy}%, You are Successfully Verified", font=("Arial", 24, "bold"))
